...
namespace Services
{
    public class AuthManager : IAuthService
    {
        ...
        {
            var user=_mapper.Map<IdentityUser>(userDto);    //identityuser elde etmek için mapleme yaptık
        ...
        public IEnumerable<IdentityUser> GelAllUsers()
        {
        ...
        public async Task<IdentityResult> ResetPassword(ResetPasswordDto userDto)
        {
